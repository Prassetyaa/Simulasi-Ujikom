...
<div class="main-container">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <input type="text" name="namaEkskul" id="namaEkskul" class="form-control" placeholder="Alamat" aria-label="First name">
        </div>
    </div>
    <div class="row">
        <div class="col">
            <label for="namaLomba" class="form-label mt-4">No. telepon</label>
            <input type="text" name="namaLomba" id="namaLomba" class="form-control" placeholder="No.telepon" aria-label="First name">
        </div>
        {{-- <div class="col">
